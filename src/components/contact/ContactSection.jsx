        ...
        <div className="w-full max-lg pt-8 lg:pt-11">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="cursor-pointer w-full bg-black text-white py-4 px-8 font-bold uppercase tracking-widest hover:bg-gray-800 transition-colors duration-300 mt-8 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
