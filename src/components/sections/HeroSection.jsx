  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-black text-white">
      ...
      <video
        ...
        playsInline
      >
        <source src="/videos/oricand-movie-1.mp4" type="video/mp4" />
      ...
      >
        ...
        <motion.p
          className="uppercase text-sm text-white tracking-[0.3em] mt-2"
          variants={{
        ...
        <motion.p
          className="mt-6 max-w-xl text-white text-base leading-relaxed"
          variants={{
